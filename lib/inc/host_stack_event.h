 ...
 * @note: host_stack_type 1
 */
static inline uint8_t host_stack_event_state_get_state(const uint8_t * event){
    return event[2];
}
 ...
 * @note: host_stack_type 1
 */
static inline uint8_t host_stack_event_nr_connections_changed_get_number_connections(const uint8_t * event){
    return event[2];
}
 ...
 * @note: host_stack_type 1
 */
static inline uint8_t host_stack_event_discoverable_enabled_get_discoverable(const uint8_t * event){
    return event[2];
}
...
/**
 * @brief Get field type from event SM_EVENT_PAIRING_COMPLETE
 * @param event packet
 * @return type
 * @note: host_stack_type 1
 */
static inline uint8_t sm_event_pairing_complete_get_type(const uint8_t * event){
    return event[13];
}
/**
 * @brief Get field type from event SM_EVENT_PAIRING_COMPLETE
 ...
 * @note: host_stack_type 1
 */
static inline const uint8_t * sm_event_pairing_complete_get_data(const uint8_t * event){
    return &event[14];
}

/**
 * @brief Get field type from event SM_EVENT_LTK_REQUEST
 * @param event packet
 * @return type
 * @note: host_stack_type 1
 */
static inline uint8_t sm_event_ltk_request_get_addr_type(const uint8_t * event){
    return event[2];
}
 ...
 * @note: host_stack_type 1
 */
static inline const uint8_t * sm_event_ltk_request_get_data(const uint8_t * event){
    return &event[3];
}
...
/**
 * @brief Get field con_handle from event HIDS_SUBEVENT_REPORT_DATA
 * @param event packet
 * @return con_handle
 * @note: host_stack_type 2
 */
static inline uint16_t hids_subevent_report_data_get_con_handle(const uint8_t * event){
    return little_endian_read_16(event, 3);
}

/**
 * @brief Get field att_handle from event HIDS_SUBEVENT_REPORT_DATA
 * @param event packet
 * @return att_handle
 * @note: host_stack_type 2
 */
static inline uint16_t hids_subevent_report_data_get_att_handle(const uint8_t * event){
    return little_endian_read_16(event, 5);
}

/**
 * @brief Get field buffer_size from event HIDS_SUBEVENT_REPORT_DATA
 * @param event packet
 * @return con_handle
 * @note: host_stack_type 2
 */
static inline uint16_t hids_subevent_report_data_get_buffer_size(const uint8_t * event){
    return little_endian_read_16(event, 7);
}
 ...
 * @note: host_stack_type 2
 */
static inline const uint8_t * hids_subevent_report_data_get_buffer(const uint8_t * event){
    return &event[9];
}
