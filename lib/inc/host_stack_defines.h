...
// packet handler
typedef void (*host_stack_packet_handler_t) (uint8_t packet_type, uint16_t channel, uint8_t *packet, uint16_t size);
 ...
 */
  ...
  * @format 1k
  * @param addr_type
  * @param address,irk,rand
  */
#define SM_EVENT_LTK_REQUEST									0xCF	
 ...
 * @param buffer
*/
#define HIDS_SUBEVENT_REPORT_DATA                                           0x0A
