...
/** @defgroup DMA_peripheral_data_size 
  * @{
  */
#define DMA_Peripheral_Memory									((uint32_t)0x0000)
#define DMA_Peripheral_UART0									((uint32_t)0x0001)
#define DMA_Peripheral_UART1									((uint32_t)0x0002)
#define DMA_Peripheral_UART2									((uint32_t)0x0003)
#define DMA_Peripheral_UART3									((uint32_t)0x0004)
#define DMA_Peripheral_SPI0										((uint32_t)0x0005)
#define DMA_Peripheral_SPI1										((uint32_t)0x0006)
#define DMA_Peripheral_SPI2										((uint32_t)0x0007)
#define DMA_Peripheral_I2C0										((uint32_t)0x0008)
...
void DMA_ChannelCmd(DMA_TypeDef* DMA_Channelx, functional_state new_state);
void DMA_Cmd(functional_state new_state);
...
void DMA_ITConfig(DMA_TypeDef* DMA_Channelx, uint32_t DMA_IT, functional_state new_state);
