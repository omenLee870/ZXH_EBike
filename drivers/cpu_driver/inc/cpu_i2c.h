...
typedef struct
{
	...
	functional_state I2C_GenerateRestartEnable;
}I2C_InitTypeDef;
...
#define I2C_ClockSpeed_200KHz					(200000)
#define I2C_ClockSpeed_300KHz					(300000)
...
#define IS_I2C_RX_FIFO_FULL_THRESHOLD(THRESHOLD)	((((int32_t)(THRESHOLD)) >= I2C_RXFIFOFullThreshold_1) && \
													  (((int32_t)(THRESHOLD)) <= I2C_RXFIFOFullThreshold_8))
/**
  * @}
  */ 
...
#define IS_I2C_TX_FIFO_EMPTY_THRESHOLD(THRESHOLD)	((((int32_t)(THRESHOLD)) >= I2C_TXFIFOEmptyThreshold_0) && \
													(((int32_t)(THRESHOLD)) <= I2C_TXFIFOEmptyThreshold_8))
/**
  * @}
  */ 
...
#define IS_I2C_DMA_RECEIVE_LEVEL(LEVEL)			((((int32_t)(LEVEL)) >= I2C_DMAReceiveLevel_1) && \
												(((int32_t)(LEVEL)) <= I2C_DMAReceiveLevel_8))
/**
  * @}
  */ 
...
#define IS_I2C_DMA_TRANSMIT_LEVEL(LEVEL)	((((int32_t)(LEVEL)) >= I2C_DMATransmitLevel_0) && \
											(((int32_t)(LEVEL)) <= I2C_DMATransmitLevel_7))
/**
  * @}
  */ 
...
void I2C_Cmd(I2C_TypeDef* I2Cx, functional_state new_state);
...
void I2C_DMACmd(I2C_TypeDef* I2Cx, uint32_t I2C_DMAReq, functional_state new_state);
...
void I2C_ITConfig(I2C_TypeDef* I2Cx,uint32_t I2C_IT, functional_state new_state);
...
void I2C_SlaveGeneralNACKOnlyCmd(I2C_TypeDef* I2Cx, functional_state new_state);
